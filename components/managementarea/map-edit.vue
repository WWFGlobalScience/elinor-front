<template>
    <section class="section section--map-edit">
                ...
                <div class="right">
                    <ul>
                        <li>
                            ...
                            <span>{{ $t( 'managementarea.map.polygon_create' ) }}</span>
                        </li>
                        <li>
                            <div class="pic__wrap">
                                <img src="~/assets/img/ico-map-closer.svg">
                             </div>
                            <span>{{ $t( 'managementarea.map.polygon_close' ) }}</span>
                        </li>
                        <li>
                            <div class="pic__wrap">
                            ...
                            <span>{{ $t( 'managementarea.map.polygon_new' ) }}</span>
                        </li>
                        <li>
                            <div class="pic__wrap">
                            ...
                            <span>{{ $t( 'managementarea.map.polygon_delete' ) }}</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <transition name="fade">
            <default-loader :loaderText="loader.loaderText" v-if="loader.active > 0"></default-loader>
        </transition>
        <transition name="fade">
...
export default {
    ...
    data() {
        return {
            ...
            error: false,
            center: this.ma.version.point.coordinates || [-68.137343, 45.137451]
        }
    },
    computed: {
        maOrigin() {
