  ...
  <section class="section section--ma-edit-selector">
    ...
    <form class="form form--ma-selector">
      <div class="form__group">
        <div class="container--sm">
          <div class="form__row">
            <div class="input input--multiselect">
              <label class="label">{{
                $t('managementarea.labels.parent')
              }}</label>
              <div class="multiselect__wrap">
                <multiselect
                  v-model="selRelatedMas.value"
                  :options="selRelatedMas.options"
                  :multiple="false"
                  :searchable="true"
                  :showLabels="false"
          ...
          <div class="form__row">
            <div class="input input-1-2 input--date">
              <label class="label">{{
                $t('managementarea.labels.date_established')
              }}</label>
              <div class="date__wrap">
                <date-picker
                  ...
                  format="yyyy-MM-dd"
                  v-model="selDateEstablishment"
                  @input="selDateEstablishmentChange"
                />
            ...
            <div class="input input-1-2">
              <label class="label">{{
                $t('managementarea.labels.reported_size')
              }}</label>
              <input
                type="text"
                name="ha"
                placeholder="0000 Ha"
                v-model="selReportedSize"
                @change="selReportedSizeChange"
              />
            </div>
          </div>
          ...
          <div class="form__row">
            <div class="input input--multiselect">
              ...
              <input
                ...
                name="ha"
                placeholder="0000 Ha"
                v-model="selMaAuthorities"
                @change="selMaAuthoritiesChange"
              />
            </div>
          </div>
          <div class="form__row">
            <div class="input input--multiselect">
              ...
              <div class="multiselect__wrap">
                <div class="multiselect__wrap">
                  <multiselect
                    v-model="selGtypes.value"
                    :options="selGtypes.options"
                    :multiple="false"
                    :searchable="true"
                    :allow-empty="true"
                    :hide-selected="true"
                    ...
                    :custom-label="customLabel"
                    :show-labels="false"
                    :placeholder="$t('default.select-single')"
                    @input="selGtypesChange"
                  >
                    <template slot="singleLabel" slot-scope="props">
                      <span class="option__desc">
        ...
        <div class="container">
          <div
            class="form__row form__row--separator form__row--separator--16"
          ></div>
        </div>
        ...
        <div class="container--sm">
          <div class="form__row form__row--mt-16">
            <div class="input input--multiselect">
              <label class="label"
                >Are the rights of the MA formally recognized at the ...</label
              >
              <div class="multiselect__wrap">
                <multiselect
                  v-model="selRecognition.value"
                  :options="selRecognition.options"
                  :multiple="false"
                  :searchable="true"
                  :showLabels="false"
                  :allow-empty="true"
                  :hide-selected="true"
                  @input="selRecognitionChange"
                >
                  <span slot="noResult">{{ $t('default.noresults') }}</span>
                </multiselect>
                <div class="multiselect__caret">
          ...
          <div class="form__row">
            <div class="input input--multiselect">
              ...
              <div class="multiselect__wrap">
                <multiselect
                  v-model="selStakeholders.value"
                  :options="selStakeholders.options"
                  :multiple="true"
                  :searchable="true"
                  :showLabels="false"
                  :allow-empty="true"
                  ...
                  :custom-label="customLabel"
                  :show-labels="false"
                  :placeholder="$t('default.select-multiple')"
                  @input="selStakeholdersChange"
                >
                  <template slot="singleLabel" slot-scope="props">
                    <span class="option__desc">
                      <span class="option__title">{{ props.option.name }}</span>
          ...
          <div class="form__row">
            <div class="input input--multiselect">
              <label class="label"
                >Does the MA management authority receive technical, financial
                or other types of support from any of the following groups or
                organizations?</label
              >
              <div class="multiselect__wrap">
                <multiselect
                  v-model="selSs.value"
                  :options="selSs.options"
                  :multiple="true"
                  :searchable="true"
                  :showLabels="false"
                  :allow-empty="true"
          ...
          <div class="form__row">
            <div class="input input--1-2">
              <label class="label"
                >If this managed area is associated with an id in the World
                Database on Protected Areas (WDPA), please enter that id?</label
              >
              <input
                type="text"
                name="id"
        ...
        <div class="container--sm">
          <div class="form__row form__row--mt-16">
            <div class="input input--multiselect">
              ...
              <div class="multiselect__wrap">
                <multiselect
                  v-model="selCountries.value"
                  :options="selCountries.options"
                  :multiple="true"
                  :searchable="true"
                  :showLabels="false"
                  :allow-empty="true"
          ...
          <div class="form__row">
            <div class="input input--multiselect">
              ...
              <div class="multiselect__wrap">
                <multiselect
                  v-model="selProvinces.value"
                  :options="selProvinces.options"
                  :multiple="true"
                  :searchable="true"
                  :showLabels="false"
                  :allow-empty="true"
...
export default {
  ...
  created() {
    this.selRelatedMas = {
      value: this.mas.versions.filter(
        (version) => version.id == this.ma.root.parent,
      ),
      options: this.mas.versions.filter(
        (version) => version.id != this.ma.version.id,
      ),
    };
    this.selDateEstablishment = this.ma.version.date_established
      ? moment(this.ma.version.date_established).toDate()
      : null;
    this.selReportedSize = this.ma.version.reported_size;
    this.selMaAuthorities = this.mas.authorities.find(
      (authority) => authority.id == this.ma.version.management_authority,
    ).name;
    this.selGtypes = {
      value: this.ma.gtype,
    ...
    this.selRecognition = {
      ...
      options: [
        this.$t('managementarea.data.recognition_level_local'),
        this.$t('managementarea.data.recognition_level_national'),
      ],
    };
  ...
  methods: {
    ...
    selRelatedMasChange() {
      this.$store.dispatch(
        'managementareas/updateRoot',
        this.selRelatedMas.value,
      );
      this.submit();
    },
    ...
    selReportedSizeChange() {
      this.$store.dispatch(
        'managementareas/updateVersionReportedSize',
        parseFloat(this.selReportedSize),
      );
      this.submit();
    },
    selMaAuthoritiesChange() {
      this.$store.dispatch(
        'managementareas/updateVersionAuthority',
        this.selMaAuthorities,
      );
      this.submit();
    },
    selGtypesChange() {
      this.$store.dispatch(
        'managementareas/updateVersionGtype',
        this.selGtypes.value,
      );
      this.submit();
    },
    selRecognitionChange() {
      this.$store.dispatch(
        'managementareas/updateVersionRecognition',
        this.selRecognition.value,
      );
      this.submit();
    },
    selStakeholdersChange() {
      this.$store.dispatch(
        'managementareas/updateVersionStakeholdergroups',
        this.selStakeholders.value,
      );
      this.submit();
    },
    selSsChange() {
