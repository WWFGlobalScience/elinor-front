            ...
            <div class="form__group">
                <div class="container--sm">
                        ...
                        <div class="input input-1-2 input--date">
                            ...
                            <div class="date__wrap">
                                ...
                                <div class="date__caret">
                                    <img
                                        src="~/assets/img/ico-date-turqy.svg"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form__row">
                        <div class="input input--multiselect">
                            <label class="label"
                                >Name of managment authority</label
                            >
                            <input
                                type="text"
                                name="ha"
                ...
                <div class="container--sm">
                    <div class="form__row form__row--mt-16">
                        <div class="input input--multiselect">
                            <label class="label"
                                >Are the rights of the MA formally recognized at
                                the ...</label
                            >
                            <div class="multiselect__wrap">
                                <multiselect
                    ...
                    <div class="form__row">
                        <div class="input input--multiselect">
                            <label class="label"
                                >Does the MA management authority receive
                                technical, financial or other types of support
                                from any of the following groups or
                                organizations?</label
                            >
                            <div class="multiselect__wrap">
                                <multiselect
                    ...
                    <div class="form__row">
                        <div class="input input--1-2">
                            <label class="label"
                                >If this managed area is associated with an id
                                in the World Database on Protected Areas (WDPA),
                                please enter that id?</label
                            >
                            <input
                                type="text"
                                name="id"
...
export default {
    ...
    created() {
        ...
        this.selDateEstablishment = moment(
            this.ma.version.date_established,
        ).toDate();
    ...
    methods: {
        ...
        selSsChange() {
            this.$store.dispatch(
                'managementareas/updateVersionSs',
                this.selSs.value,
            );
            this.submit();
        },
