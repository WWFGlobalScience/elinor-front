...
export default {
    ...
    methods: {
        isPublished() {
            return this.assessment.data_policy === 90 && this.assessment.status === 10;
        },
        isFinalized() {
            return this.assessment.data_policy === 10 && this.assessment.status === 10
        }
    }
}
</script>
