        ...
        <div class="container">
            <header id="question" class="header--back">
                ...
                <nuxt-link
                    ...
                    class="elinor__back btn btn--border-turqy btn--opacity"
                >
                    <img src="~/assets/img/ico-arrow-back-turqy.svg" alt="" />
                    <span>{{
                        $t('pages.assessments.edit.tabs.survey.questions.back')
                    }}</span>
                </nuxt-link>
            </header>
            <div class="">
                        ...
                        <nav class="question__nav">
                            <ul>
                                <li>
                                    ...
                                    >
                                        <img
                                            src="~/assets/img/ico-arrow-back-turqy.svg"
                                        />
                                        <span>{{
                                            $t(
                                                'pages.assessments.edit.tabs.survey.questions.prev',
                                            )
                                        }}</span>
                                    </nuxt-link>
                                </li>
                                <li>
                                    ...
                                    >
                                        <span>{{
                                            $t(
                                                'pages.assessments.edit.tabs.survey.questions.next',
                                            )
                                        }}</span>
                                        <img
                                    ...
                                    <nuxt-link
                                        v-if="
                                            isLastQuestionInSurvey && !isOffline
                                        "
                                    ...
                                    >
                                        <span>{{
                                            $t(
                                                'pages.assessments.edit.tabs.nextStep',
                                            )
                                        }}</span>
                                        <img
                                            src="~/assets/img/ico-button-arrow-turqy.svg"
