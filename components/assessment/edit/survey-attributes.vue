                        ...
                        >
                            ...
                            <div class="item-content">
                                ...
                                >
                                    {{
                                        $t(
                                            'pages.assessments.edit.seeQuestions',
                                        )
                                    }}
                                </a>
                            </div>
                ...
                <div class="elinor__survey-attribute-group">
                    <div class="title-border">
                        <h3 class="title">
                            {{
                                $t(
                                    'pages.assessments.edit.optionalAttributesTitle',
                                )
                            }}
                        </h3>
                    </div>
                    <p class="text-intro">
                        {{
                            $t(
                                'pages.assessments.edit.optionalAttributesDescription',
                            )
                        }}
                    </p>
                    <ul class="elinor__survey-attribute-gird">
                        ...
                        >
                            <div class="option-check">
                                ...
                                <div class="content">
                                    <h4
                                        class="title"
                                        for="survey-attribute-optional-1"
                                    >
                                        {{ attribute.name }}
                                    </h4>
                                    <h5 class="subtitle">
