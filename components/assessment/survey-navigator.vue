<template>
  <section
    class="section section--assessment-survey section--mt-0 bg-[#F9F9F9]"
  >
    <div class="container">
      <div class="elinor__survey-progress">
        ...
        <div class="elinor__survey-complete elinor__survey-complete--no-border">
          <div class="index">
            {{ completedQuestions }}
          </div>
          <div class="text">
            <span>{{
              $t('pages.assessments.edit.tabs.survey.navigator.completed')
            }}</span>
            <span
              >{{ $t('pages.assessments.edit.tabs.survey.navigator.outOf') }}
              {{ totalQuestions }}</span
            >
          </div>
        </div>
