<template>
    <div class="assessment__btns">
        <a v-if="false && assessment.status === 10" @click="download" role="button" class="btn btn--border-turqy btn--sm" title="Download Data"><img src='~/assets/img/ico-download.svg' alt="Download Data"/> <span>{{ $t('default.downloadData') }}</span></a>
