<template>
  <section class="section section--assessment-survey-list">
    <div class="container">
      <header class="survey-list-header">
        <h4>{{ $t('pages.assessments.view.tabs.survey.attributeScoresTitle') }}</h4>
        <p>
          {{ $t('pages.assessments.view.tabs.survey.description') }}
        </p>
      </header>
      ...
      <div class="elinor__survey-list">
        <div class="survey-list-header">
          <h4>{{ $t('pages.assessments.view.tabs.survey.surveyAnswersTitle') }}</h4>
              ...
              >
                ...
                <div class="title-aside">
                  ...
                  >
                    ...
                    />
                    <span>{{
                      $t('pages.assessments.view.tabs.survey.attributes.active')
                    }}</span>
                  </span>
                </div>
              </div>
                ...
                <div class="right">
                  ...
                  >
                    <template v-if="isAnswered(question)">
                      ...
                      <div class="answer">
                        <span
                          v-html="
                            question[answersMapping[getAnswerChoice(question)]]
                          "
                        ></span>
                      </div>
                  ...
                  <div v-if="!isAttributeChecked(attribute)" class="q-msg">
                    <p class="txt__inactive">
                      The attribute which contains this questions is not
                      selected
                    </p>
                  </div>
                </div>
