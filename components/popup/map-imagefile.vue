  ...
  <div class="popup__content">
    <form class="form form--mt-0">
                ...
                <div class="file">
                  ...
                  >
                    <div class="file__drag">
                      ...
                      <span v-if="!managementArea.map_image">{{
                        $t('default.upload-mapimage.placeholder')
                      }}</span>
                      <span v-if="managementArea.map_image"
                        ><img
                          :src="managementArea.map_image"
      ...
      <div v-if="fileAdded" class="popup__map image">
        ...
        <div ref="mapContainer" class="elinor__map" style="padding: 0"></div>
      </div>
      <div v-if="fileAdded" class="popup__footer">
        ...
        <button @click="accept" type="button" class="btn btn--opacity--child">
