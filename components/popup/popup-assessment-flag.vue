                ...
                <div class="form__group">
                        ...
                        <div class="input input--multiselect input--1-4">
                            <div class="multiselect__wrap">
                                <multiselect
                                    :placeholder="
                                        $t(
                                            'pages.assessments.actions.flag.placeholder',
                                        )
                                    "
                                    track-by="id"
                                    label="name"
                    ...
                    <div class="form__row">
                        <div class="input">
                            <label class="label">{{
                                $t(
                                    'pages.assessments.actions.flag.labelTextarea',
                                )
                            }}</label>
                            ...
                            <template v-if="errors.explanation">
                                <p
                                    class="msg msg--error"
                                    v-for="error in errors.explanation"
                                >
                                    {{ error }}
                                </p>
                            </template>
...
export default {
            ...
            flagTypes: [
                {
                    id: 'inappropriate',
                    name: this.$t(
                        'pages.assessments.actions.flag.types.inappropriate',
                    ),
                },
                {
                    id: 'personal',
                    name: this.$t(
                        'pages.assessments.actions.flag.types.personal',
                    ),
                },
                {
                    id: 'inaccurate',
                    name: this.$t(
                        'pages.assessments.actions.flag.types.inaccurate',
                    ),
                },
                {
                    id: null,
    ...
    methods: {
        ...
        getFlagTypeOption(id) {
            const filtered = this.flagTypes.filter(
                (flagType) => flagType.id === id,
            );
            if (filtered.length) {
                return filtered[0];
            }
