<template>
  <div class="popup__content popup--small">
                ...
                <div class="file">
                  ...
                  >
                    <div class="file__drag">
                      ...
                      <span>{{
                        $t('pages.assessments.uploadSurveyFile.filePlaceholder')
                      }}</span>
                    </div>
                  </dropzone>
                  ...
                  <!--STEP 3 - SUCCESS-->
                  <div
                    v-if="progress === 100 && !surveyFileError"
                    class="description"
                  >
                    <img
                    ...
                    <br />
                    <br />
                    <img src="~/assets/img/ico-file-error.svg" />
                    <p style="color: red">
                      {{
                        $t('pages.assessments.uploadSurveyFile.uploadWarning')
                      }}
                    </p>
                    <br />
                    <br />
                  ...
                  >
                    ...
                    <p
                      style="color: red"
                      v-for="error in getErrors(surveyFileError)"
                    >
                      {{ error }}
                    </p>
                    <p>
                      {{
                        $t('pages.assessments.uploadSurveyFile.tryAgainText')
                      }}
                      <a @click="clearSurveyFile" role="button">{{
                        $t('pages.assessments.uploadSurveyFile.tryAgainButton')
                      }}</a>
                    </p>
                  </div>
                  <!--//STEP 3 - ERROR-->
      ...
      <div class="right">
        <template v-if="!fileAdded || progress < 100 || surveyFileError">
          ...
          <div class="description">
            <p
              v-html="$t('pages.assessments.uploadSurveyFile.help')"
              v-if="!fileAdded || progress < 100 || surveyFileError"
            />
          </div>
        </template>
    ...
    <div class="file__buttons">
      ...
      >
        <span class="btn--opacity__target">{{
          $t('pages.assessments.uploadSurveyFile.triggerButton')
        }}</span>
        <!-- <img
      ...
      <p v-if="dropzoneAccepted === false" class="msg msg--error">
        {{ $t('pages.assessments.uploadSurveyFile.formatNotSupported') }}
      </p>
