        ...
        <div class="content-report">
            ...
            >
                <div class="flex gap-2 flex-col items-center">
                    ...
                    >
                        <span
                            class="text-white text-[40px] font-montserratSemiBoldPdf"
                        >
                            {{ score }}
                        </span>
                    </div>
                ...
                <div class="text">
                    ...
                    <ul
                        class="mt-5 flex flex-row justify-items-start items-center gap-2"
                    >
                        <template
                            v-for="(
                                managementArea, index
                            ) in selectedFilters.managementAreas"
                        >
            ...
            <div class="h-full pt-8 static">
                <table class="table-score-assessment">
                    ...
                    <tbody
                        v-for="assessment in assessments.slice(
                            index * 6,
                            index * 6 + 6,
                        )"
                    >
                        ...
                        <tr class="wrapper-row">
                            <td>
                                <span
                                    ...
                                    :class="
                                        'bg-' +
                                        getAssessmentColor(assessment.score)
                                    "
