          ...
          >
            <template v-if="isAttributeChecked(attribute)">
              <div
                ...
                :class="
                  'bg-' +
                  (group ? getAttributeColor(group.score) : 'grayy-lighter')
                "
              >
                {{
          ...
          <div class="rounded-3xl bg-turqy-lighter p-3">
            <table class="table-score-values table-score-values--report block">
              <tr>
                <th></th>
                <th>
                  {{ $t('pages.report.totalScores.indicator') }}<br />{{
                    $t('pages.report.totalScores.value')
                  }}
                </th>
                <th>
                  {{ $t('pages.report.totalScores.attribute') }}<br />{{
                    $t('pages.report.totalScores.value')
                  }}
                </th>
                <th>
                  {{ $t('pages.report.totalScores.aggregate') }}<br />{{
                    $t('pages.report.totalScores.value')
                  }}
                </th>
              </tr>
              <tr>
                <td>
                  <div class="item-legend">
                    ...
                    <p class="text">
                      {{ $t('pages.report.totalScores.plan.title') }}
                    </p>
                  </div>
                </td>
                <td class="num">0</td>
                ...
                <td colspan="4" class="hr">
                  <div class="flex justify-center items-center">
                    <span class="description">{{
                      $t('pages.report.totalScores.plan.description')
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="item-legend">
                    ...
                    <p class="text">
                      {{ $t('pages.report.totalScores.build.title') }}
                    </p>
                  </div>
                </td>
                <td class="num">1</td>
              ...
              <tr>
                <td colspan="4" class="hr">
                  <div class="flex justify-center items-center">
                    <span class="description">{{
                      $t('pages.report.totalScores.build.description')
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="item-legend">
                    ...
                    <p class="text">
                      {{ $t('pages.report.totalScores.strengthen.title') }}
                    </p>
                  </div>
                </td>
                <td class="num">2</td>
              ...
              <tr>
                <td colspan="4" class="hr">
                  <div class="flex justify-center items-center">
                    <span class="description">{{
                      $t('pages.report.totalScores.strengthen.description')
                    }}</span>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="item-legend">
                    ...
                    <p class="text">
                      {{ $t('pages.report.totalScores.maintain.title') }}
                    </p>
                  </div>
                </td>
                <td class="num">3</td>
                ...
                <td colspan="4" class="hr">
                  <div class="flex justify-center items-center">
                    <span class="description border-transparent">{{
                      $t('pages.report.totalScores.maintain.description')
                    }}</span>
                  </div>
                </td>
              </tr>
