                ...
                <div v-if="report.management_area" class="card-map">
                    <div class="card-map-col">
                        <p v-if="report.management_area.date_established">
                            ...
                            <strong>{{
                                new Date(
                                    report.management_area.date_established,
                        ...
                        <p v-if="report.management_area.governance_type">
                            ...
                            <strong>{{
                                report.management_area.governance_type
                            }}</strong>
                        </p>
                        <p v-if="hectareas">
                            {{ $t('pages.report.aside.totalHa') }}
                            <strong
                                >{{ hectareas.toLocaleString($i18n.locale) }} h
                            </strong>
                        </p>
                    </div>
                    <div class="card-map-col self-start">
                        ...
                        <p v-if="report.management_area.version_date">
                            ...
                            <strong>{{
                                new Date(
                                    report.management_area.version_date,
                                ).toLocaleDateString($i18n.locale)
                            }}</strong>
                        </p>
                        <!--<p>
    ...
    computed: {
        ...
        hectareas() {
            if (this.managementArea.polygon) {
                ...
                return this.managementArea.polygon.coordinates
                    ? Number(area)
                    : 0;
            } else {
                return null;
