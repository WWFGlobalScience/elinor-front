<template>
    <div class="popup__content popup--collaborator-add">
        ...
        <p class="c-text--base mb-8">
            {{
                $t(
                    'pages.assessments.edit.tabs.collaborators.popups.add.description',
                )
            }}
        </p>
                ...
                <div class="form__row">
                    <div class="input input--multiselect input--3-4">
                        <label class="label">
                            {{
                                $t(
                                    'pages.assessments.edit.tabs.collaborators.popups.add.selectCollaboratorLabel',
                                )
                            }}
                            <span
