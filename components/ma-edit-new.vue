                ...
                <div class="container--sm">
                    ...
                    <div class="form__row">
                        <div class="input">
                            ...
                            <div
                                v-if="
                                    editWdpaId || !managementArea.protected_area
                                "
                        ...
                        <div class="input input--multiselect">
                            ...
                            <div class="multiselect__wrap">
                                <multiselect
                                    ...
                                    @input="
                                        onSelectChanged('containedby', $event)
                                    "
                                    @search-change="
                                        onSelectSearch(
                    ...
                    <div class="form__row">
                        <div class="input input-1-2 input--date">
                            ...
                            <div class="date__wrap">
                                <date-picker
                                    ...
                                    format="MM/dd/yyyy"
                                    :value="managementArea.date_established"
                        ...
                        <div class="input input-1-2">
                            ...
                            <input
                                ...
                                @change="
                                    save('reported_size', $event.target.value)
                                "
                            />
                        </div>
                    </div>
                    ...
                    <div class="form__row">
                        <div class="input input--pr">
                            ...
                            <textarea
                                ...
                                "
                                >{{ managementArea.objectives }}</textarea
                            >
                        </div>
                    </div>
                </div>
                ...
                <div class="container--sm">
                    ...
                    >
                        <div class="input input--multiselect">
                            ...
                            <div id="geocoder"></div>
                            <div
                                class="section section--tags section--tags-filter"
                            >
                                <ul>
                                    <li
                                        v-for="region in managementArea.regions"
                                    >
                                        <div class="tag__item">
                                            {{ region.name }}
                                        </div>
                                ...
                                <div class="radio__wrap">
                                    <div class="radio">
                                        <input
                                            ...
                                            id="zone-yes"
                                            @change="
                                                onShowZones($event.target.value)
                                            "
                    ...
                    <div class="form__row form__row--mt-16" v-if="showZones">
                        <div class="input input--multiselect">
                            ...
                            <div class="multiselect__extra">
                                ...
                                >
                                    <div
                                        class="form__row form__row--mt-7 tit-row"
                                    >
                                ...
                                <div class="btn-row">
                                    <a
                                        @click="onAddZone"
                                        role="button"
                                        class="btn--border-turqy mt-12 ml-8"
                                    >
                                        <span>{{
                                            $t(
