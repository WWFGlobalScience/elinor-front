  ...
  methods: {
    ...
    renderChart() {
      ...
      svg
        ...
        .attr(
          ...
          d3
            ...
            .outerRadius((d) => {
              return y(this.getScoreByAttribute(d) * 33.33);
            })
      ...
      svg
        ...
        .selectAll('g')
        .data([{ label: 25 }, { label: 50 }, { label: 75 }, { label: 100 }])
        .join('g')
        .attr('fill', 'none')
        .style('stroke', 'none')
        .call((g) =>
      ...
      svg
        ...
        .on(
          'mouseover',
          (event, d) =>
            (document.querySelector(`#tooltip-${d.id}`).style.opacity = '1'),
        )
        .on(
          'mouseout',
          (event, d) =>
            (document.querySelector(`#tooltip-${d.id}`).style.opacity = '0'),
        )
