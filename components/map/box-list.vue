<template>
    <div class="box-map font-montserrat">
        ...
        <div
            class="p-4 flex items-center justify-start gap-2 bg-turqy-lighter border-t border-grayy-border"
        >
            <p class="text-m font-light">
                <strong class="font-bold text-turqy">{{
                    assessments.length
                }}</strong>
                Assessments
                <span v-if="countryHa > 0">
                    {{ $t('pages.map.boxList.covering') }} <br />
                    {{
            ...
            <li v-for="report in assessments">
                ...
                >
                    <div
                        ...
                        :class="
                            'bg-' + getAssessmentColor(report.properties.score)
                        "
                    >
                    ...
                    <div class="flex flex-1 flex-col gap-0">
                        ...
                        <p
                            ...
                            class="text-dark text-xs font-semibold leading-4"
                        >
                            {{
                                Number(
                                    report.properties.hectares,
