<template>
    <form
        action=""
        class="map-filters absolute z-10 top-4 right-[60px] flex flex-row gap-4"
    >
        <div class="w-[230px]">
            <div class="input input--multiselect">
                <div class="multiselect__wrap multiselect__wrap--map">
                    <multiselect
                        ...
                        "
                        @input="
                            onFilterChanged('country', $event ? $event : null)
                        "
                    ></multiselect>
            ...
            <div class="input input--multiselect">
                <div class="multiselect__wrap multiselect__wrap--map">
                    <multiselect
                        ...
                        @input="
                            onFilterChanged('attribute', $event ? $event : null)
                        "
                    >
                    </multiselect>
                    <div class="multiselect__caret">
    ...
    computed: {
        ...
        countries() {
            ...
            const englishCountriesCodes = englishCountries
                .filter(
                    (country) => this.mapCountries.indexOf(country.name) !== -1,
                )
