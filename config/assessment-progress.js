...
export const calculateProgress = (assessment) => {
    ...
    for (let field of required_fields.managed_area) {
        ...
        if (managementArea && managementArea[field])
            progress.managed_area.filled++;
    ...
    progress.overall_percentage +=
        (25 * progress.managed_area.percentage) / 100;
    ...
    progress.overall_percentage +=
        (25 * progress.collaborators.percentage) / 100;
