export default [
  {
    ...
    text: `
  A new study published in Conservation Biology leverages data from the ElinorData.org platform to assess the current status of community-based coastal governance across 52 community-managed areas in five Southwest Indian Ocean (SWIO) countries. The findings reveal that stronger local governance is significantly associated with better perceived social and ecological outcomes, though progress remains uneven across attributes like operational capacity and adaptive management. This new study shows that conservationists can utilize the Elinor platform to identify shifting governance gaps over time, share localized management innovations, and design more targeted, evidence-informed interventions for long-term conservation success. Read the full study here - https://conbio.onlinelibrary.wiley.com/doi/epdf/10.1111/cobi.70325        `,
  },
  {
    date: '2-28-2024',
