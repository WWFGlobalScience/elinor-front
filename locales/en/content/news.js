export default [
  {
    date: '7-05-2026',
    title: 'Elinor used to assess the status and trends of community governance in the Southwest Indian Ocean',
    text: `
  A new study published in <em>Conservation Biology</em> leverages data from the ElinorData.org platform to assess the current status of community-based coastal governance across 52 community-managed areas in five Southwest Indian Ocean (SWIO) countries. The findings reveal that stronger local governance is significantly associated with better perceived social and ecological outcomes, though progress remains uneven across attributes like operational capacity and adaptive management. This new study shows that conservationists can utilize the Elinor platform to identify shifting governance gaps over time, share localized management innovations, and design more targeted, evidence-informed interventions for long-term conservation success. Read the full study here - <a href="https://conbio.onlinelibrary.wiley.com/doi/epdf/10.1111/cobi.70325">https://conbio.onlinelibrary.wiley.com/doi/epdf/10.1111/cobi.70325</a>`,
  },
  {
    date: '2-28-2024',
  ...
  },
  {
    date: '6-20-2022',
    title:
      'New Elinor updates allow automated reporting and more user-friendly features',
    text: `
