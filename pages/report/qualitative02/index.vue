<template>
  <div class="h-full pt-8 static">
    ...
    <div class="grid grid-cols-2 gap-12">
      <div class="col-span-1 grid gap-12 self-start ml-16">
        <h2 class="font-montserratBoldPdf text-[16px]">
          Year of PA establishmnet:
          <span class="font-montserratMediumPdf text-[20px]">2016</span>
        </h2>
        <div class="keys-card ui-rounded-border">
          ...
          <p class="font-montserratMediumPdf text-sm">
            ...
            recusandae reprehenderit nobis officia sint quisquam, veritatis,
            deserunt odit vero fugit ea repellat explicabo reiciendis molestias
            quasi quidem animi magni qui.
          </p>
        </div>
        <div class="keys-card ui-rounded-border">
          <h4 class="title text-sm font-montserratSemiBoldPdf">
      ...
      <div class="col-span-1 grid gap-12 self-start">
        <h2 class="font-montserratBoldPdf text-[16px]">
          Year we start working with partners:
          <span class="font-montserratMediumPdf text-[20px]">2016</span>
        </h2>
        <div class="keys-card ui-rounded-border">
          <h4 class="title text-sm font-montserratSemiBoldPdf">Partners</h4>
          <ul class="list-keys">
        ...
        <div class="keys-card ui-rounded-border">
          <h4 class="title text-sm font-montserratSemiBoldPdf">Donors</h4>
          <ul class="list-keys">
            <li>Resource boundaries need to be clearly defined</li>
            <li>Enhance monitoring and sanctioning</li>
          </ul>
