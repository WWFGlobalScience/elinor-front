    ...
    <article class="page page--create-account">
        <header class="header--page">
            <div class="container--sm">
                <h1 class="c-title--sm">{{ $t('pages.auth.registration.title') }}</h1>
                ...
                <div class="container--sm">
                    <div id="error" class="form__group" v-if="error">
                        <div class="mb-10 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                            <strong class="font-bold">{{ $t('pages.auth.registration.validationErrorTitle') }}</strong>
                        </div>
                    </div>
                        ...
                        <div id="password1" class="form__row">
                            <div class="input">
                                <input :class="{'input--error': hasError('password1')}" v-model="form.password1" type="password" name="password1"
                                       :placeholder="$t( 'pages.auth.registration.inputs.password1' )">
                        ...
                        <div id="password2" class="form__row">
                            <div class="input">
                                <input :class="{'input--error': hasError('password2')}" v-model="form.password2" type="password" name="password2"
                                       :placeholder="$t( 'pages.auth.registration.inputs.password2' )">
                        ...
                        <div id="first_name" class="form__row">
                            <div class="input">
                                <input :class="{'input--error': hasError('first_name')}" v-model="form.first_name" type="text" name="first_name"
                                       :placeholder="$t( 'pages.auth.registration.inputs.firstname' )">
                        ...
                        <div id="last_name" class="form__row">
                            <div class="input">
                                <input :class="{'input--error': hasError('last_name')}" v-model="form.last_name" type="text" name="last_name"
                                       :placeholder="$t( 'pages.auth.registration.inputs.lastname' )">
                        ...
                        <div id="username" class="form__row">
                            <div class="input">
                                <input :class="{'input--error': hasError('username')}" v-model="form.username" type="text" name="username"
                                       :placeholder="$t( 'pages.auth.registration.inputs.username' )">
                        ...
                        <div class="form__group">
                            ...
                            <div class="form__row">
                                <div class="input input--checkbox">
                                    <div class="checkbox">
                                        <input v-model="form.accept_tor" type="checkbox" id="terms-of-service" name="terms-of-service">
                                        <img src="~/assets/img/ico-checkbox.svg">
                                    </div>
                                    <label for="terms-of-service">{{ $t('pages.auth.registration.termsOfServiceCheckbox') }}</label>
                                </div>
                            </div>
                            ...
                            <div class="form__row flex justify-end mt-10">
                                <button type="submit" form="form--signin" class="btn btn--opacity--child">
                                    <span class="btn--opacity__target">{{ $t('pages.auth.registration.createAccountButton') }}</span>
