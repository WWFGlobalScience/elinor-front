    ...
    <article class="page page--flushed">
        <section class="section section--sign-in">
            ...
            <div class="elinor__card elinor__card--sign-in">
                ...
                <div
                    v-if="error"
                    class="bg-red-100 border border-red-400 text-white-700 px-4 py-3 rounded relative mt-5"
                    role="alert"
                >
                        ...
                        <div class="form__row">
                            <div class="input">
                                <input
                                    ...
                                    :placeholder="
                                        $t(
                                            'pages.auth.resetPassword.password1Input',
                                        )
                                    "
                                    v-model="password1"
                                    required
                        ...
                        <div class="form__row">
                            <div class="input">
                                <input
                                    ...
                                    :placeholder="
                                        $t(
                                            'pages.auth.resetPassword.password2Input',
                                        )
                                    "
                                    v-model="password2"
                                    required
                        ...
                        <div>
                            ...
                            >
                                <span class="btn--opacity__target">{{
                                    $t(
                                        'pages.auth.resetPassword.changePasswordButton',
                                    )
                                }}</span>
