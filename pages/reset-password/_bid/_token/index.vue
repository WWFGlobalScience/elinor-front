  ...
  <article class="page page--flushed">
    <section class="section section--sign-in">
      ...
      <div class="elinor__card elinor__card--sign-in">
        ...
        <div v-if="error" class="bg-green-100 border border-green-400 text-white-700 px-4 py-3 rounded relative"
             role="alert">
        ...
        <form id="form--reset-password" class="form form--sign-in" @submit="submit">
          <div class="form__group">
            <div class="form__row">
              <div class="input">
                <input type="password" :placeholder="$t('pages.auth.content.reset-password.password1-placeholder')"
                       v-model="password1" required/>
              </div>
            </div>
            <div class="form__row">
              <div class="input">
                <input type="password" :placeholder="$t('pages.auth.content.reset-password.password2-placeholder')"
