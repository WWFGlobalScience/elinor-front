<template>
  <article class="page page--flushed page--contact">
    ...
    <section class="section section--contact !mt-0 !py-[56px]">
      <div class="container">
        <div class="g-grid--4-1-lg flex items-center">
          <div class="g-colspan--3-full-lg">
            <form v-if="sent === true" class="form !mt-0">
            ...
            <form v-if="sent === false" class="form !mt-0">
              <fieldset class="form__group px-0">
                <legend class="form__legend">
                  <h3 class="text-turqy text-bold">
                    {{ $t('pages.contact.form.legend.strong') }}
                  </h3>
                  <br />
                  <div class="text-base leading-[30px] font-medium py-4">
                ...
                <div class="form__row">
                  <div class="input">
                    ...
                    <input
                      ...
                      :placeholder="$t('pages.contact.form.mailPlaceholder')"
                      v-model="email"
                    />
                ...
                <div class="row-btn justify-start">
