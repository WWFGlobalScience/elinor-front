<template>
  <article class="page page--flushed page--methodology">
    <section class="section section--banner">
      <img src="~/assets/img/methodology-banner.jpg" alt="" />
      <div class="container">
        <h1>
    ...
    <div class="page--methodology__content">
      <section class="section section--approach">
        <div class="container">
          <div>
            <h3 class="text-[#43A0BD]">The Approaches</h3>
            <div class="section-subtitle">
              <p>{{ $t('pages.methodologyPage.paragraph1') }}</p>
            </div>
          </div>
          <div class="approach-grid">
            <div class="approach-grid__item">
              <div class="approach-grid__item__image">
                <img src="~/assets/img/approach-1.jpg" alt="" />
              </div>
              <div class="approach-grid__item__content">
                <h4>
                ...
                <div class="flex mt-[28px]">
                  <a
                    target="_blank"
                    href="https://elinor-user-files.s3.amazonaws.com/dev/Document/2/Elinor_assessment_tool_protocol_v2022.1.pdf"
                    class="btn btn--md"
                  >
            ...
            <div class="approach-grid__item">
              <div class="approach-grid__item__image">
                <img src="~/assets/img/approach-2.jpg" alt="" />
              </div>
              <div class="approach-grid__item__content">
                <h4>
                  {{ $t('pages.methodologyPage.subtitle2') }}
                </h4>
                <p>{{ $t('pages.methodologyPage.practice1') }}</p>
                <p>{{ $t('pages.methodologyPage.practice2') }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section section--background">
        <div class="container">
          <div>
            <h3 class="text-[#43A0BD]">
              {{ $t('pages.methodologyPage.subtitle3') }}
            </h3>
            <div class="section-subtitle">
              <p>{{ $t('pages.methodologyPage.aq1') }}</p>
            </div>
          </div>
          <div v-html="content" class="question"></div>
          <div class="section-subtitle">
            <p v-html="$t('pages.methodologyPage.aq2')"></p>
            <p>{{ $t('pages.methodologyPage.aq3') }}</p>
          </div>
          <div class="background-grid">
            <div class="background-grid__item col-span-2">
                ...
                <table class="table-background">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>
                        {{ $t('pages.background.attribute_title.name') }}
                      </th>
                      <th>
                        {{ $t('pages.background.attribute_title.description') }}
                      </th>
                      <th>
                        {{ $t('pages.background.attribute_title.useIf') }}
                      </th>
      ...
      <section class="section section--score-table">
        <div class="container">
          <div>
            <h3 class="text-[#43A0BD]">
              {{ $t('pages.methodologyPage.subtitle4') }}
            </h3>
            <div class="section-subtitle">
              <p>{{ $t('pages.methodologyPage.score1') }}</p>
              <p>{{ $t('pages.methodologyPage.score2') }}</p>
            </div>
          </div>
          <score-table />
        </div>
...
import attributeList from '~/components/methodology/attribute-list.vue';
import locales from '../../locales';
import { mapState } from 'vuex';

export default {
  components: { scoreTable, attributeList },
  name: 'methodology',
  auth: false,
  data() {
    return {
  ...
  methods: {
    ...
    updateExpandState(index, isExpanded) {
      if (isExpanded) {
        this.expandedItems.add(index);
      } else {
