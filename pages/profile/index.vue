    ...
    <section class="page">
        <div class="container--md">
            <div class="grid-profile">
                <div class="avatar">
                    <div class="elinor__avatar elinor__avatar--xl bg-turqy">
                        <span>X</span>
                    </div>
                </div>
                <div class="name">
                    <h1 class="c-title--lg uppercase mb-2">
                        <strong>{{ $t('pages.profile.header.title') }}</strong>
                    </h1>
                ...
                <div class="content">
                    ...
                    >
                        <strong class="font-bold">{{
                            $t(
                                'pages.home.public.alerts.profileUpdatedSuccessfully.title',
                            )
                        }}</strong>
                            ...
                            <div class="form__row">
                                <div class="input">
                                    <label for="first_name" class="label"
                                        >{{
                                            $t('pages.profile.form.first_name')
                                        }}*</label
                                    >
                                    <input
                                        type="text"
                            ...
                            <div class="form__row">
                                <div class="input">
                                    <label for="last_name" class="label"
                                        >{{
                                            $t('pages.profile.form.last_name')
                                        }}*</label
                                    >
                                    <input
                                        type="text"
                ...
                <div v-if="false" class="content mt-20">
                    ...
                    <h4 class="c-title--base font-semibold mb-4">
                        {{ $t('pages.profile.delete.subtitle') }}
                    </h4>
                    <ul class="list-inside list-disc list-delete">
                        <li class="list-item">
                            {{ $t('pages.profile.delete.list.1') }}
                        </li>
                        <li class="list-item">
                            {{ $t('pages.profile.delete.list.2') }}
                        </li>
                        <li class="list-item">
                            {{ $t('pages.profile.delete.list.3') }}
                        </li>
                        <li class="list-item">
                            {{ $t('pages.profile.delete.list.4') }}
                        </li>
                    </ul>
                    ...
                    <div class="row-btn">
                        ...
                        >
                            <span class="btn--opacity__target">{{
                                $t('pages.profile.delete.confirm.title')
                            }}</span>
                            <img
                                src="~/assets/img/ico-button-arrow.svg"
                                alt=""
                        ...
                        <p>
                            <strong class="c-text--warning c-text--base">{{
                                $t(
                                    'pages.profile.delete.confirm.message.strong',
                                )
                            }}</strong>
                            {{
