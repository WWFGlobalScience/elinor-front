    ...
    <article class="page page--flushed">
        <section class="section section--sign-in">
            ...
            <div class="elinor__card elinor__card--sign-in">
                ...
                <p class="text-base">
                    {{ $t('pages.auth.content.sign-in.subtitle') }}
                </p>
                ...
                >
                    ...
                    <span class="block sm:inline"
                        >Do not remember the password? Try the forgot
                        password</span
                    >
                </div>
                ...
                >
                    <strong class="font-bold"
                        >Email verification required!</strong
                    >
                    <span class="block sm:inline"
                        >Have you not received the verification email? If not
                        resend it again</span
                    >
                </div>

                <div
                    v-if="alerts.emailVerificationSent"
                    class="bg-green-100 border border-green-400 text-white-700 px-4 py-3 rounded relative"
                    role="alert"
                >
                    <strong class="font-bold">Email verification sent!</strong>
                    <span class="block sm:inline"
                        >You will receive a message to verify your email</span
                    >
                </div>
        ...
        <section class="section section--intro section--turqy-light">
            <div class="container">
                ...
                <p class="section--intro__info">
                    Elinor is a flexible tool and data system designed to track
                    the management, governance, and equity status in areas under
                    protection or management. Elinor seeks to streamline data
                    collection, entry, and visualization for information on
                    management, governance, and equity while also allowing
                    flexibility on how data is gathered.
                </p>
            ...
            <div class="container">
                <div class="section--img-text__block">
                    <div class="section--img-text__block-text">
                        ...
                        <p>
                            Elinor can be applied as either a field-based
                            assessment with a trained facilitator or as a
                            desk-based tool that harnesses local and
                            practitioner knowledge.
                        </p>
                        <p>
                            The questions within Elinor are high-level, covering
                            a broad range of topics and have been designed to
                            supplement and not replace in-depth research
                            exploring issues like equity, governance, gender and
                            climate change.
                        </p>
                    </div>
            ...
            <div class="section--img-text__block is-flushed">
                ...
                <div class="container">
                    <div class="section--img-text__block-text">
                        ...
                        <p>
                            Elinor has been designed primarily to help track
                            changes over time, thus can be used at any stage in
                            the project cycle to
                        </p>
                        <ul class="list-disc list-inside">
                            <li>
                                Indicate the suitability of a site for
                                conservation
                            </li>
                            <li>
                                Highlight areas that require more focused
                                interventions to enhance implementation efforts.
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="g-grid--2-1-lg items-center">
                    <div class="text-center lg:order-2">
                        ...
                        <blockquote class="elinor__sentence mx-auto">
                            “Little by little, bit by bit, family by family, so
                            much good can be done on so many levels.”
                    ...
                    <div class="lg:order-1">
                        ...
                        <p>
                            Elinor Ostrom was the first woman to win the Nobel
                            Prize in economics in 2009, but her legacy extends
                            far beyond that singular honor. Ostrom and her
                            colleagues countered the dominant narrative around
                            the tragedy of the commons (which argued that
                            individuals pursue their own interest even when it
                            goes against the collective good—made famous by an
                            ecologist who was a known racist and eugenicist).
                            Ostrom’s theory on governing the commons proved that
                            our planet could be protected through community,
                            collaboration, and cooperation.
                        </p>
                        <p>
                            Research on the governance of common pool resource
                            management pushed boundaries of science and
                            challenged the usual divisions between disciplines.
                            Working in true partnership with others who
                            understood the world in different ways, Ostrom and
                            her colleagues paved the way for a new research
                            community and body of knowledge that embraces
                            diversity and the intertwined nature of human and
                            natural systems.
                        </p>
                        <p>
                            Ostrom’s legacy shapes how we work today in
                            conservation, and by honoring her in our work, we
                            hope that her insights can help us all better
                            support both the communities and governance systems
                            that protect our natural resources now and into the
                            future.
                        </p>
                    </div>
                </div>
...
export default {
    ...
    mounted() {
        ...
        if (
            this.$route.params.verification === 'password-changed-successfully'
        ) {
            this.$store.commit('authentication/setAlert', {
