<template>
    <section class="section section--assessment-collaborators" v-if="!loader.active">
        <div class="container">
        ...
        <div class="mt-12">
            <assessment-collaborators-list v-if="!isAssessmentCollaborator($auth, assessment)"></assessment-collaborators-list>
            <assessment-edit-collaborators-list v-if="isAssessmentCollaborator($auth, assessment)"></assessment-edit-collaborators-list>
        </div>
    </section>
</template>
