        ...
        >
            <div class="form__group">
                    ...
                    <div class="form__row">
                        <div class="input input--multiselect">
                            <label class="label"
                                >{{
                                    $t(
                                        'pages.assessments.edit.tabs.data.labels.year',
                                    )
                                }}*</label
                            >
                    ...
                    <div class="form__row">
                        <div class="input">
                            <label class="label"
                                >{{
                                    $t(
                                        'pages.assessments.edit.tabs.data.labels.name',
                                    )
                                }}*</label
                            >
                            <input
                    ...
                    <div class="form__row form__row--mt-16">
                        <div class="input input--multiselect">
                            <label class="label"
                                >{{
                                    $t(
                                        'pages.assessments.edit.tabs.data.labels.organization',
                                    )
                                }}*</label
                            >
                            <div class="multiselect__wrap">
                    ...
                    <div class="form__row">
                        <div class="input input--pr">
                            ...
                            <textarea
                                ...
                                "
                                >{{
                                    assessment.collection_method_text
                                }}</textarea
                            >
                        </div>
                    </div>
                ...
                <div class="container--sm">
                    <div class="form__row form__row--mt-16">
                        <div class="input">
                            <label class="label"
                                >{{
                                    $t(
                                        'pages.assessments.edit.tabs.data.people.title',
                                    )
                                }}*</label
                            >
                        </div>
                    ...
                    <div class="form__row">
                        <div
                            class="input input--multiselect input--1-2 input--flexy"
                        >
                            <div class="multiselect__wrap">
                                <input
                                    type="hidden"
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.people.community',
                                )
                            }}</label>
                        </div>
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.people.ngo',
                                )
                            }}</label>
                        </div>
                    </div>
                    <div class="form__row">
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.people.academic',
                                )
                            }}</label>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.people.government',
                                )
                            }}</label>
                        </div>
                    </div>
                    <div class="form__row">
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.people.indigenous',
                                )
                            }}</label>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.people.private',
                                )
                            }}</label>
                        </div>
                    </div>
                    <div class="form__row form__row--mt-16">
                        <div class="input">
                            <label class="label"
                                >{{
                                    $t(
                                        'pages.assessments.edit.tabs.data.gender.title',
                                    )
                                }}*</label
                            >
                        </div>
                    ...
                    <div class="form__row">
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.gender.female',
                                )
                            }}</label>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.gender.male',
                                )
                            }}</label>
                        </div>
                    </div>
                        ...
                        >
                            <div class="multiselect__wrap">
                                ...
                                <multiselect
                                    ...
                                    open-direction="bottom"
                                    @input="
                                        save('count_gender_nonbinary', $event)
                                    "
                                >
                                    <span slot="noResult">{{
                                        $t('default.noresults')
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.gender.nonBinary',
                                )
                            }}</label>
                        </div>
                        <div
                        ...
                        >
                            <div class="multiselect__wrap">
                                <input
                                    ...
                                    class="input__dummy"
                                    :value="
                                        assessment.count_gender_prefer_not_say
                                    "
                                />
                                <multiselect
                                    placeholder=""
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.gender.preferNotToSay',
                                )
                            }}</label>
                        </div>
                    </div>
                    ...
                    <div class="form__row form__row--mt-16">
                        <div class="input input--radios">
                            <label class="label"
                                >{{
                                    $t(
                                        'pages.assessments.edit.tabs.data.labels.consentGiven',
                                    )
                                }}*</label
                            >
                                ...
                                <div class="radio__wrap">
                                    <div class="radio">
                                        <input
                                            ...
                                            "
                                            :checked="
                                                assessment.consent_given_written
                                            "
                                        />
                                        <img src="~/assets/img/ico-ok.svg" />
                                    </div>
                                    <label
                                        for="consentGivenWritten-yes"
                                        class="label"
                                        >{{ $t('default.yes') }}</label
                                    >
                                </div>
                ...
                <div class="container--sm">
                    <div class="form__row form__row--mt-16">
                        <div class="input input--file">
                            ...
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.labels.managementPlan.maxSize',
                                )
                            }}</label>
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.labels.managementPlan.maxUploadTime',
                                )
                            }}</label>
                            <label class="label">{{
                                $t(
                                    'pages.assessments.edit.tabs.data.labels.managementPlan.anyFile',
                                )
                            }}</label>
                                ...
                                >
                                    <div class="file__drag">
                                        ...
                                        <div>
                                            <span
                                                v-if="
                                                    !assessment.management_plan_file
                                                "
                                                >{{
                                                    $t(
                                                        'default.upload-file.placeholder',
                                                    )
                                                }}</span
                                            >
                                            <span v-else
                                ...
                                <div class="file__buttons">
                                    ...
                                    >
                                        ...
                                        <span class="btn--opacity__target">{{
                                            $t(
                                                'default.upload-file.buttons.select',
                                            )
                                        }}</span>
                                    </button>
                                    <button
                                        v-if="assessment.management_plan_file"
                                        @click="clearManagementPlan"
                                        type="button"
                                        class="btn--border-turqy btn--opacity--child"
                                    >
                                        <img
                                        ...
                                        <span class="btn--opacity__target">{{
                                            $t(
                                                'default.upload-file.buttons.clear',
                                            )
                                        }}</span>
                                    </button>
                                </div>
            ...
            roles: [
                {
                    id: 10,
                    name: this.$t(
                        'pages.assessments.personResponsibleRoles.10',
                    ),
                },
                {
                    id: 20,
                    name: this.$t(
                        'pages.assessments.personResponsibleRoles.20',
                    ),
                },
                {
                    id: 30,
                    name: this.$t(
                        'pages.assessments.personResponsibleRoles.30',
                    ),
                },
                {
                    id: 40,
                    name: this.$t(
                        'pages.assessments.personResponsibleRoles.40',
                    ),
                },
                {
                    id: 50,
                    name: this.$t(
                        'pages.assessments.personResponsibleRoles.50',
                    ),
                },
                {
                    id: 60,
                    name: this.$t(
                        'pages.assessments.personResponsibleRoles.60',
                    ),
                },
            ],
            collection_methods: [
    ...
    methods: {
        ...
        async clearManagementPlan() {
            ...
            this.$refs.managementPlan.$el.childNodes[0].childNodes[0].childNodes[1].innerHTML =
                '<span>' +
                this.$t('default.upload-file.placeholder') +
                '</span>';
        },
        save(field, value) {
