        ...
        <ul class="ma__results" v-if="mas.length >= 1">
          ...
          >
            ...
            <ul class="sublist">
              ...
              <li class="role">
                <span class="label">{{
                  $t('pages.managed-areas.content.ma.labels.role')
                }}</span>
                <span class="data">Admin</span>
              </li>
              <li class="ha">
                <span class="label">{{
                  $t('pages.managed-areas.content.ma.labels.ha')
                }}</span>
                <span class="data">{{ ma.size }}</span>
              </li>
              <li class="assessments">
                <span class="label">{{
                  $t('pages.managed-areas.content.ma.labels.assessments')
                }}</span>
        ...
        <ul class="ma__results" v-else>
          <li class="elinor__badge ui-rounded-border elinor__badge--empty">
            <header class="header">
              <div class="left">
                <span class="title">{{
                  $t('pages.managed-areas.content.showing.empty')
                }}</span>
              </div>
            </header>
          </li>
